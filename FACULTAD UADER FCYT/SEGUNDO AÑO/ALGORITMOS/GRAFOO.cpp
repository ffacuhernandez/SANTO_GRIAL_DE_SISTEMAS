...
{
	int id_nodo;
	struct nodo_arco* lista_arco; //LISTA DE ARCOS
	struct nodo_grafo* link; // CONECTAR CON OTROS NODOS
};
...
{
	int id_arco;
	struct nodo_grafo* destino; // APUNTA AL NODO DE DESTINO DEL ARCO
	struct nodo_arco* link; //CONECTA CON OTROS ARCOS
};
